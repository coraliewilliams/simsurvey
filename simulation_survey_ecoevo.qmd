...
# Load journal lists
jcr_stats <- read_csv("data/JCR_JournalResults_09_2022_Statistics_and_Probability.csv", skip = 2)
jcr_eco <- read_csv( "data/JCR_JournalResults_09_2022_Ecology.csv", skip = 2)
jcr_evo <- read_csv("data/JCR_JournalResults_09_2022_Evolutionary_Biology.csv", skip = 2)
