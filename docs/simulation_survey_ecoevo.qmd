---
title: "Survey of Current Practices of Simulation Studies for Statistical Method Evaluation in Ecology and Evolutionary Biology"
...
This webpage contains the R code used for the survey analysis presented in the paper "*Transparent Reporting Items for Simulation Studies Evaluating Statistical Methods: Foundations for Reproducibility and Reliability*".

In our survey, we assessed and characterised 100 research articles in ecology and evolution journals featuring simulation studies evaluating statistical methods.
...
Corresponding author contact: [coralie.williams@unsw.edu.au](mailto:coralie.williams@unsw.edu.au?subject=%20Simulation%20study%20practices%20in%20EcoEvo)
...
r <- c("1.1.aims_reporting", 
       ...
       "2.7.3.datagen_simulationruns_justification",
...
r_labels <- c("1. aims stated", 
              "2. data generation mechanisms described", 
              "2. number of simulation runs justified",
              "3. estimand/target(s) stated",
              "4. relevant literature cited from methods",
              "5. performance measures described",
              "5. performance measures less known defined",
              "6.programming language(s) provided",
              "6. package provided",
