...
ggplot(survey, aes(x = `1.3.aims_purpose`)) +
  ...
  theme(
    axis.text.x = element_text(angle = 30, hjust = 1, size = 12), # Increase text size and adjust angle
    axis.text.y = element_text(size = 12),  # Increase text size for y-axis
    axis.title.x = element_text(size = 12), # Increase title size for x-axis
    axis.title.y = element_text(size = 12), # Increase title size for y-axis
    panel.background = element_blank(),
