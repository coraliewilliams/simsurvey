...
variable_names <- c("1.3.aims_purpose", "2.3.datagen_type", "2.4.datagen_informed",
                    "2.7.3.datagen_simulationruns_justification", "4.3.method_type"
                    ,"7.3.code_datagen_basedonprevious", "9.1.analysis_exploratory",
                    "11.1.analysis_montecarlo_uncertainty", "1.2.aims_reportingsection",
...
# colorrrrs
colors <- c("#CCCCFF", "#FFE4B5", "#CCFFCC", "#FFFFCC", "#CCFFFF", "#FFE4E1", "#FFCCFF", "#F0E68C", 
            "#E6E6FA", "#FFFACD", "#ADD8E6", "#FFEFD5", "#AFEEEE", "#DDA0DD", "#FFCCCC","#F5F5DC",  
