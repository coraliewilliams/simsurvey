...
pacman::p_load(
  rmarkdown, readr, dplyr, plyr, purrr, splitstackshape, tidyverse, tidyr, ggplot2,
  vroom, details, sessioninfo, devtools, readxl, here
)
...
############
# IMPORTANT: modified merge() code below as of 20/09/2023, before this code was merging on all columns and only matched 15 journals and missed 3 journals that were overlapping due to different values in "JIF Quartile" column
###########
...
![](~/Projects/simsurvey/data/img/abstractscreening.png)

### Full-text screening

![](~/Projects/simsurvey/data/img/fulltextscreening.png)

# Data cleaning

```{r}
# Load text extraction
survey <- read_excel("~/Projects/simsurvey/data/survey/simulationSurvey_extraction_103papers_21092023.xlsx")

# remove excluded papers
survey_test <- survey %>% filter(is.na(`Cross check`))
