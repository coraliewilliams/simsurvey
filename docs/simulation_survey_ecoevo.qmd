...
variable_names <- c(
  "1.3.aims_purpose", "2.3.datagen_type", "2.4.datagen_informed",
...
# colorrrrs
colors <- c("#CCCCFF", "#FFE4B5", "#CCFFCC", "#FD9ECC", "#CCFFFF", "#FFE4E1", "#FFCCFF", "#F0E68C", 
            "#E6E6FA", "#DAE315", "#ADD8E6", "#FEEFD5", "#AAE1EE", "#DDA0DD", "#FFCCCC", "#A5F5EE",  
            "#FFFD58", "#E0FFFF", "#D8BFD8", "#F5DEB3", "#F0FFF0", "#FAFAD2", "#FFF0F5", "#5EDDD2",
            "#FFF5EE", "#A1EE55", "#F0FFFF", "#EDFBD7", "#F59EFA", "#FDF5E6", "#F1D8F0", "#F1C158",
            "#FFF0F5", "#F1A993", "#D29DEE", "#FDD1FF", "#F0FFFF", "#F66EDD", "#F5D42D", "#FDF5E6")
