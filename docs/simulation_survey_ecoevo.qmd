...
percent_rs$value <- replace_na(percent_rs$value, "N.A.")
percent_rs$value <- factor(percent_rs$value, levels=c("N.A.", "No", "Yes"))
...
`10.1.analysis_perfmeasures_reporting`	  Were all performance measures results reported graphically or in tabular format? 
